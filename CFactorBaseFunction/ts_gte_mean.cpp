...
//[[Rcpp::export]]
Rcpp::NumericVector ts_gte_mean(
...
/*
library("Rcpp")
sourceCpp(file="ts_gte_mean.cpp")
print(ts_gte_mean(c(1,2,3,4,4), 3, TRUE, 2, method=2))

library("Rcpp")
sourceCpp(file="ts_gte_mean.cpp")
print(ts_gte_mean(c(1,2,3,4,4), 3, TRUE, 2, method=1))
